...
#### Ссылка на предсказание цен квартир. 
https://team-a-estate.streamlit.app
...
- Первичное форматирование/парсинг данных. 
- Очистка и подготовка датасета к обучению. 
- Анализ данных. 
- Общее оформление. 

- Использовался pandas, streamlit. 


Участник 2 - Павлов Дмитрий. 
- Построение графиков/анализ выбросов. 
- Кодирование строковых признаков датасета. 
- Нормализация данных и обучение модели. 
- Оформление веб приложение для финального предсказания модели. 

- Использовался pandas streamlit, matplotlib, sklearn. 
...
- Построение графиков. 
- Оформление EDA. 
- Оформление веб приложения EDA, общее оформление. 

- Использовался pandas, streamlit, matplotlib